...
// by iWoozy_Real - OPEN SOURCE - V0.4
...
// ==UserScript==
// @name         F.E.A.R. V0.4 | Forcefully Eliminating Advertising Redirects (Retarded Errors fixed!)
// @namespace    iWoozie
// @version      0.4
...
(async function () {
    ...
    // Luarmor Loader
    class Luarmor { static getKey() { setInterval(() => { try { location.href = new URL([...document.getElementById("nextbtn").getAttribute("onclick").matchAll(/'([^']+)'/g)][1][1]); } catch {} }, 2500); } }
